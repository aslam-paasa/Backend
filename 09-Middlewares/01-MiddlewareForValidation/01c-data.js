/**
 * File-1: Foundational File which holds the data, but it doesn't 
 *         execute any logic by itself.
 * 
 * 1. Purpose:
 * => Contains a list of car objects that represent mock data for the
 *    application.
 * 
 * 2. Export:
 * => Export the cars array, which allow it to be imported into other
 *    files.
*/
const cars = [
